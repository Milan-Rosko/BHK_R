...
(*                concept, discarding redundant implementations          *)
(*                previously used for extensionality checks.             *)
(*            (c) Total: Witnessed by structural or measure-based        *)
(*                recursion that reduces to kernel normal forms.         *)
(*                                                                       *)
(*     (iii)  Boundary.No new axioms are introduced here. The global     *)
(*            inversion law for the resulting pairing will be handled    *)
(*        	  exclusively by the Reflexica certificate layer.            *)
(*                                                                       *)
(*************************************************************************)
