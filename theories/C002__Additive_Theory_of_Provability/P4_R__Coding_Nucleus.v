...
(*                                                                       *)
(*  Design.                                                             *)
(*    - Atom and Code are abstract.                                     *)
(*    - Pairing on codes is abstract (may be unused by some codecs).     *)
(*    - Sequence decoding is fuelled explicitly.                         *)
(*    - CODEC_OK packages a codec plus explicit constructive witnesses   *)
(*      for the basic sequence round-trip property.                      *)
(*                                                                       *)
(*************************************************************************)
...
Module C_002_Coding_Nucleus_R.
  ...
  Record CODEC : Type := {
    ...
    (* pairing on codes (may be trivial in early drafts) *)
